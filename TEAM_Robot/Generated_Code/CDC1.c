...
#if CDC1_CONFIG_USE_TIMEOUT && CDC1_CONFIG_APP_TASK_TIMEOUT_MS>0
  timeout = TMOUT1_GetCounter(CDC1_CONFIG_APP_TASK_TIMEOUT_MS/TMOUT1_TICK_PERIOD_MS); /* set up timeout counter */
#endif
...
#endif
    WAIT1_WaitOSms(2); /* wait some time */
  }
#if CDC1_CONFIG_USE_TIMEOUT && CDC1_CONFIG_APP_TASK_TIMEOUT_MS>0
